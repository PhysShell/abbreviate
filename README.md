...
контекстных кейсах: `ну првт → привет`, `в првт → приват` при одном вводе
(`--lm data/lm/ru-lm.tsv`). Следующий шаг — Android-оболочка. Дорожная
карта — в конце ARCHITECTURE.md.
